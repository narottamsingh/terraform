    ...
    "Statement": [
        {
            ...
            "Resource": "arn:aws:dynamodb:us-east-1:291548415763:table/student"
        }
    ]
}
)
...
resource "aws_api_gateway_integration" "my_get_integration" {
  ...
  uri                     = "arn:aws:apigateway:us-east-1:lambda:path/2015-03-31/functions/arn:aws:lambda:us-east-1:291548415763:function:DB_READ_LAMBDA/invocations"
...
resource "aws_lambda_permission" "api_gateway_permission" {
  ...
  function_name = aws_lambda_function.dynamodb_reader_lambda.arn
